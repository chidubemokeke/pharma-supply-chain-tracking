...
use substreams::prelude::*; // Import common Substreams traits and macros
use substreams::store::{StoreGet, StoreSet, Store}; // Import store traits for handling data storage
use substreams_ethereum::pb::eth::v2::{Block, Log}; // Import Ethereum block and log types

include!(concat!(env!("OUT_DIR"), "/substreams.rs")); // Include the generated protobuf Rust code
